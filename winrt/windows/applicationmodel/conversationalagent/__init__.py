...
_ns_module = winrt._import_ns_module("Windows.ApplicationModel.ConversationalAgent")
...
ActivationSignalDetectionConfiguration = _ns_module.ActivationSignalDetectionConfiguration
ActivationSignalDetectionConfigurationCreationResult = _ns_module.ActivationSignalDetectionConfigurationCreationResult
ActivationSignalDetector = _ns_module.ActivationSignalDetector
ConversationalAgentDetectorManager = _ns_module.ConversationalAgentDetectorManager
ConversationalAgentSession = _ns_module.ConversationalAgentSession
ConversationalAgentSessionInterruptedEventArgs = _ns_module.ConversationalAgentSessionInterruptedEventArgs
ConversationalAgentSignal = _ns_module.ConversationalAgentSignal
ConversationalAgentSignalDetectedEventArgs = _ns_module.ConversationalAgentSignalDetectedEventArgs
ConversationalAgentSystemStateChangedEventArgs = _ns_module.ConversationalAgentSystemStateChangedEventArgs
DetectionConfigurationAvailabilityChangedEventArgs = _ns_module.DetectionConfigurationAvailabilityChangedEventArgs
DetectionConfigurationAvailabilityInfo = _ns_module.DetectionConfigurationAvailabilityInfo
