...
class Color(_winrt.winrt_base):
    ...

class WindowId(_winrt.winrt_base):
    ...

class ColorHelper(_winrt.winrt_base):
    ...
...
class Colors(_winrt.winrt_base):
    ...
    alice_blue: Color
    antique_white: Color
    aqua: Color
...
class UIContentRoot(_winrt.winrt_base):
    ...
    u_i_context: UIContext

class UIContext(_winrt.winrt_base):
    ...
