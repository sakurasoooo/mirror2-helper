...
class WebError(_winrt.winrt_base):
    ...
    def get_status(hresult: int) -> WebErrorStatus:
        ...

class IUriToStreamResolver(_winrt.winrt_base):
    ...
    def uri_to_stream_async(uri: winrt.windows.foundation.Uri) -> winrt.windows.foundation.IAsyncOperation[winrt.windows.storage.streams.IInputStream]:
        ...
