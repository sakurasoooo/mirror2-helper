...
namespace py::cpp::Windows::ApplicationModel::UserActivities::Core
{
    ...
    static PyMethodDef _methods_CoreUserActivityManager[] = {
        { "create_user_activity_session_in_background", (PyCFunction)CoreUserActivityManager_CreateUserActivitySessionInBackground, METH_VARARGS | METH_STATIC, nullptr },
        { "delete_user_activity_sessions_in_time_range_async", (PyCFunction)CoreUserActivityManager_DeleteUserActivitySessionsInTimeRangeAsync, METH_VARARGS | METH_STATIC, nullptr },
        { nullptr }
    };
...
PyMODINIT_FUNC
PyInit__winrt_Windows_ApplicationModel_UserActivities_Core (void) noexcept
{
