...
namespace py::cpp::Windows::UI::Input::Preview
{
    ...
    static PyMethodDef _methods_InputActivationListenerPreview[] = {
        { "create_for_application_window", (PyCFunction)InputActivationListenerPreview_CreateForApplicationWindow, METH_VARARGS | METH_STATIC, nullptr },
        { nullptr }
    };
...
PyMODINIT_FUNC
PyInit__winrt_Windows_UI_Input_Preview (void) noexcept
{
