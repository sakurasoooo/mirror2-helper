...
namespace py::cpp::Windows::Management::Core
{
    ...
    static PyMethodDef _methods_ApplicationDataManager[] = {
        { "create_for_package_family", (PyCFunction)ApplicationDataManager_CreateForPackageFamily, METH_VARARGS | METH_STATIC, nullptr },
        { "_from", (PyCFunction)_from_ApplicationDataManager, METH_O | METH_STATIC, nullptr },
        { nullptr }
    };
...
PyMODINIT_FUNC
PyInit__winrt_Windows_Management_Core (void) noexcept
{
