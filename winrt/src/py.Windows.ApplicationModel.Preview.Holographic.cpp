...
namespace py::cpp::Windows::ApplicationModel::Preview::Holographic
{
    ...
    static PyMethodDef _methods_HolographicApplicationPreview[] = {
        { "is_current_view_presented_on_holographic_display", (PyCFunction)HolographicApplicationPreview_IsCurrentViewPresentedOnHolographicDisplay, METH_VARARGS | METH_STATIC, nullptr },
        { "is_holographic_activation", (PyCFunction)HolographicApplicationPreview_IsHolographicActivation, METH_VARARGS | METH_STATIC, nullptr },
        { nullptr }
    };
    ...
    static PyMethodDef _methods_HolographicKeyboardPlacementOverridePreview[] = {
        { "get_for_current_view", (PyCFunction)HolographicKeyboardPlacementOverridePreview_GetForCurrentView, METH_VARARGS | METH_STATIC, nullptr },
        { "reset_placement_override", (PyCFunction)HolographicKeyboardPlacementOverridePreview_ResetPlacementOverride, METH_VARARGS, nullptr },
        { "set_placement_override", (PyCFunction)HolographicKeyboardPlacementOverridePreview_SetPlacementOverride, METH_VARARGS, nullptr },
        { "_from", (PyCFunction)_from_HolographicKeyboardPlacementOverridePreview, METH_O | METH_STATIC, nullptr },
        { nullptr }
    };
...
PyMODINIT_FUNC
PyInit__winrt_Windows_ApplicationModel_Preview_Holographic (void) noexcept
{
