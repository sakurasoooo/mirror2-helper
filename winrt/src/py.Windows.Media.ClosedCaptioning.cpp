...
namespace py::cpp::Windows::Media::ClosedCaptioning
{
    ...
    static PyMethodDef _methods_ClosedCaptionProperties[] = {
        { "get_background_color", (PyCFunction)ClosedCaptionProperties_get_BackgroundColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_background_opacity", (PyCFunction)ClosedCaptionProperties_get_BackgroundOpacity, METH_NOARGS | METH_STATIC, nullptr },
        { "get_computed_background_color", (PyCFunction)ClosedCaptionProperties_get_ComputedBackgroundColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_computed_font_color", (PyCFunction)ClosedCaptionProperties_get_ComputedFontColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_computed_region_color", (PyCFunction)ClosedCaptionProperties_get_ComputedRegionColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_font_color", (PyCFunction)ClosedCaptionProperties_get_FontColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_font_effect", (PyCFunction)ClosedCaptionProperties_get_FontEffect, METH_NOARGS | METH_STATIC, nullptr },
        { "get_font_opacity", (PyCFunction)ClosedCaptionProperties_get_FontOpacity, METH_NOARGS | METH_STATIC, nullptr },
        { "get_font_size", (PyCFunction)ClosedCaptionProperties_get_FontSize, METH_NOARGS | METH_STATIC, nullptr },
        { "get_font_style", (PyCFunction)ClosedCaptionProperties_get_FontStyle, METH_NOARGS | METH_STATIC, nullptr },
        { "get_region_color", (PyCFunction)ClosedCaptionProperties_get_RegionColor, METH_NOARGS | METH_STATIC, nullptr },
        { "get_region_opacity", (PyCFunction)ClosedCaptionProperties_get_RegionOpacity, METH_NOARGS | METH_STATIC, nullptr },
        { nullptr }
    };
...
PyMODINIT_FUNC
PyInit__winrt_Windows_Media_ClosedCaptioning (void) noexcept
{
